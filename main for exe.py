...
#path = "C:/fsi/"    # Chemin d'accès par défaut / A MODIFIER SI CHANGEMENT DE POSTE
...
player_shoot_img_path = f"{path}\\player_shoot.png"
player_hit_img_path = f"{path}\\player_hit.png"
missile_img_path = f"{path}\\justice.png"
background_img_path = f"{path}\\background3.gif"
bullet_mob_img_path = f"{path}\\bullet_mob.png"
explosion_img_path = f"{path}\\explosion.png"
fumees_img_path = f"{path}\\fumees.png"
wave_img_path = f"{path}\\wave.png"
brandon_img_path = f"{path}\\brandon.png"
...
def difficulty_selector():
    ...
    background_menu_image = PhotoImage(file=f"{path}\\background2.png")

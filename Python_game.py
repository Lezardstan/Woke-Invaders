...
class Mobs:
    ...
    def __init__(self, x_position, life):
        ...
        self.life = life
        parent_mob.place(relx=self.x_position, rely=0.1, anchor='center')
        instances += 1
...
class Player:
    def __init__(self, position, life):
        ...
        self.life = life
        parent_player.place(relx=0.5,rely=self.position, anchor='center')
...
# def check_no_mobs():
#    if Mobs.instances == 0:
#        messagebox.showinfo("Félicitations !", "Vous avez gagné youpi")
#        main.quit()
